package com.aditya.microservice.gateway.routes;
...
public class Routes {
    ...
    // functional endpoint programming model. came with SpringWebMvcfn (functions are used to route and handle
    // request instead of annotation.)
    // use of function endpoint for rounding instead of annotation base routing.
    @Bean
    ...
    public RouterFunction<ServerResponse> fallbackRouter(){
        return GatewayRouterFunctions.route("fallbackRoute")
                .GET("/fallbackRoute", _ -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE).body("Service Unavailable"))
                .build();
    }
